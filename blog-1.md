...
TypeScript will not complain, even though notExistingMethod() does not exist. This can cause runtime errors.

Because any bypasses TypeScript’s safety system, it is called a type safety hole.
